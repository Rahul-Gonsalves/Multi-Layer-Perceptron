...
def evaluation(model, best_model_state, best_val_acc):
    ...
    if best_model_state is not None:
        try:
            ...
            print("Warning: failed to load best model state:", e)
    else:
        print("No best model state found; evaluating current model parameters.")
